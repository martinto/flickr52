...
class EventLogsControllerTest < ActionController::TestCase
  ...
  test "should create event_log" do
    assert_difference('EventLog.count') do
      post :create, event_log: { backtrace: @event_log.backtrace, message: @event_log.message, when: @event_log.when }
    end
  ...
  test "should update event_log" do
    patch :update, id: @event_log, event_log: { backtrace: @event_log.backtrace, message: @event_log.message, when: @event_log.when }
    assert_redirected_to event_log_path(assigns(:event_log))
  end
